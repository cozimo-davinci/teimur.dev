...
export const myProjects = [
    ...
    },
    {
        ...
        desc: "An advanced real-time face detection model utilizing a dual-headed neural network for precise and " +
            "efficient facial recognition, designed to enhance security and biometric applications.",
        subdesc: "Initially developed as a foundational face detection model, " +
            "this project aims to evolve into a comprehensive facial recognition system, integrating additional features such as emotion analysis, identity verification, and multi-face tracking in future iterations.",

        href: 'https://github.com/cozimo-davinci/face_detection_model',
        texture: '/textures/project/face_detection_demo.mp4',
        logo: '/assets/face_detection-logo.png',
        logoStyle: {
...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
        ...
        ringPosition: isSmall ? [-5, 7, 0] : isMobile ? [-10, 10, 0] : isTablet ? [-12, 10, 0] : [-23, 10, 0],
