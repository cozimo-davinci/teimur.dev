            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                ...
                <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <a className="flex items-center gap-2 cursor-pointer text-white-600 hover:animate-bounce hover:border-b-2 hover:border-white" href={currentProject.href} target="_blank" rel="noreferrer">
                            <p>Check Live Site</p>
                    ...
                    <div className="flex justify-between items-center mt-7">
                        <button className="arrow-btn hover:scale-105 hover:border-b-4 hover:border-white" onClick={() => handleNavigation("previous")}>
                            <img src="/assets/left-arrow.png" alt="left arrow" className="w-4 h-4" />
                        </button>
                        <button className="arrow-btn hover:scale-105 hover:border-b-4 hover:border-white" onClick={() => handleNavigation("next")}>
